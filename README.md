...
Create a local environment file with your Anthropic key before starting the app:
...
4. Redeploy the project so the serverless route can access the key.
5. Verify the app loads and the AI actions complete successfully in production.
...
- Under **Kanban**, drag any deal (e.g., _E-Commerce Rebranding_ valued at ₹85,000) from _Negotiation_ to **Won** using native HTML5 drag-and-drop. Column totals will auto-calculate instantly.
...
- Select your client profile (e.g., _Webcraft Solutions_).
